...
public class FakeSettingsRepository {
    ...
    public static List<Setting> settings = Arrays.asList(
            createSetting(-1L, Double.MAX_VALUE, 0L),
            createSetting(-2L,  Double.MAX_VALUE, 0L),
            createSetting(274L, 14L),
            createSetting(100L, 13L),
            createSetting(115L, 12L),
            createSetting(89L, 17.0, BASE_PREPARE_TIME, false),
            createSetting(90L, 17.0, BASE_PREPARE_TIME, false),
            createSetting(105L, 14L),
            createSetting(116L, 1200L),
            createSetting(88L, 14L),
            createSetting(86L, 13L),
            createSetting(91L, 10L),
